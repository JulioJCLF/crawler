...
## Critérios de aceite
- [ ] **Dado** uma categoria com 10+ produtos na execução anterior que zera na execução atual, **quando** o snapshot for processado, **então** um alerta é gerado citando a categoria.
- [ ] **Dado** uma categoria com 10+ produtos na execução anterior que cai 50% ou mais (mas não zera), **quando** o snapshot for processado, **então** um alerta é gerado citando a categoria.
- [ ] **Dado** uma categoria com menos de 10 produtos na execução anterior, **quando** ela cair ou zerar, **então** nenhum alerta é gerado (abaixo do piso da RN3).
- [ ] **Dado** uma categoria com queda abaixo de 50%, **quando** o snapshot for processado, **então** nenhum alerta é gerado.
- [ ] **Dado** a primeira execução (sem snapshot anterior), **quando** o snapshot for processado, **então** nenhum alerta de queda é gerado (não há o que comparar).
